...
urlpatterns = [
    ...
    path('get_task_status/<str:task_id>/', other_views.get_task_status, name='generate_profile'),
    ...
    path('generate-advice/<user_id>/', other_views.generate_advice_task, name='advice'),
